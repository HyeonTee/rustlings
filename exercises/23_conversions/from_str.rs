...
// TODO: Complete this `FromStr` implementation to be able to parse a `Person` out of a string in the form of "Mark,20".
// Note that you'll need to parse the age component into a `u8` with something like `"4".parse::<u8>()`.
//
// Steps:
// 1. Split the given string on the commas present in it.
// 2. If the split operation returns less or more than 2 elements, return the error `ParsePersonError::BadLen`.
